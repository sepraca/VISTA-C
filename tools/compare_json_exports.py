#!/usr/bin/env python3
"""Compare two VISTA-C JSON exports for numerical identity (JSON only -- for PNG
exports use plain `shasum -a 256`; they carry no timestamp).
...
Usage
-----
    python3 tools/compare_json_exports.py A.json B.json
    python3 tools/compare_json_exports.py A.json B.json --keep-generated
    python3 tools/compare_json_exports.py A.json            # canonical hash only
    python3 tools/compare_json_exports.py A.json B.json --max-diffs 200
